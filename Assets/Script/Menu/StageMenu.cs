...
public class StageMenu : MonoBehaviour
{
    ...
    [SerializeField] Text textSongComposer = null;
    [SerializeField] Text textSongScore = null;
    ...
    void SettingSong()
    {
        ...
        textSongComposer.text = songList[currentSong].composer;
        textSongScore.text = string.Format("{0:###0}", theDatabase.score[currentSong]);
